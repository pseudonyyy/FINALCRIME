...
#printButton {
    ...
    font-size: 16px;
    cursor: pointer;
    background-color: #a4b7e4; /* Light grey */
    border: none;
    border-radius: 5px;
}
...
<div class="buttons-container" style="display: flex; justify-content: start; gap: 10px;">
  <div class="registration-button-container">
    <button type="button" onclick="showRegistrationModal()">Register Person Data</button>
  </div>
  <div class="form-button-container">
    <button type="button" onclick="window.location.href='form.php'">Go to Form</button>
  </div>
</div>
...
<div id="registrationModal" class="modal">
  <div class="modal-content">
    ...
    <!-- Registration form -->
    <form id="registrationForm" method="post" action="record.php">
        ...
        <label for="idType" class="inline-label">ID Card Type:
            <select id="idType" name="idType">
                ...
                <option value="HDMF ID">HDMF (Pag-IBIG ID)</option>
                <option value="National ID">National ID</option>
                <option value="EPhil ID">EPhil ID</option>
            </select>
        </label>

        <label for="idNumber" class="inline-label">ID Card Number:
